...
\AtBeginDocument{
	\hypersetup{colorlinks,urlcolor=purple!80!black}
}                                                            
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{multicols}{3}
			...
			\item \textbf{Analysis:} \begin{itemize}
				\item Real Analysis
			...
			\columnbreak
			\item \textbf{Algebra:} \begin{itemize}
				\item Linear Algebra 
				\item Group Theory 
				\item Ring Theory
				\item Field Theory
...
\end{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{Programming Languages:} Python (Basic), Haskell (Basic), Java (Basic), Unix/Linux Shell Scripting
		
		\item \textbf{Technical Skills:} \LaTeX, Git, Basic works in terminal, VIM

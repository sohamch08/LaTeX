...
\leftheader{%
  {\LARGE\bfseries\sffamily Soham Chatterjee}

  % \makefield{\faEnvelope[regular]}{\href{mailto:sohamchatterjee999@gmail.com}{\texttt{sohamchatterjee999@gmail.com}}}
  ...
  \makefield{\faEnvelope[regular]}{\href{mailto:soham.chatterjee@tifr.res.in}{\texttt{soham.chatterjee@tifr.res.in}}}
  % \makefield{{\scriptsize\simpleicon{x}}}{\!\href{https://x.com/overleaf_example}{\texttt{@overleaf\_example}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/soham-chatterjee-513b77202/}{\texttt{profile}}}
\makefield{\faGithub[regular]}{\href{https://github.com/sohamch08}{\texttt{sohamch08}}}
  %% Next line
  
  \makefield{\faGlobe}{\href{https://sohamch08.github.io}{sohamch08.github.io}}
...
\makerubrichead{Research Intereset}
...
% \makerubric{skills}
\makerubric{workshop}
% \makerubrichead{TA-Ship}
% \begin{itemize}
% 	\item Algorithms, TIFR, 2025 by T. Kavitha
% \end{itemize}
\input{courses}
\makerubric{internships}
\makerubric{achievements}
\makerubric{misc}
\makerubric{computer-skills}
% \makerubric{referee}
% \input{referee-full}

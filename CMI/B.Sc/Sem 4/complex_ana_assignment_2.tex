...
\pagebreak
	...
	\solve{
		...
		\subsection*{Case 1: $\bs{\vph(i)=ie^{i\theta}}$} 
		...
		\subsection*{Case 2: $\bs{\vph(i)=-ie^{i\theta}}$} 
		We claim that $\vph(z)=\barz e^{i\theta}=\overline{ze^{i\theta}}$. We just need to check the equalities in \eqref{eq1}\begin{align*}
			|\vph(z)-\vph(0)|&=|\barz e^{i\theta}|=|\barz |=|z|\\
			|\vph(z)-\vph(1)|&= |\bar ze^{i\theta}-e^{i\theta}|=|(\bar z-1)e^{i\theta}|=|\bar z-1|=|z-1|\\
			|\vph(z)-\vph(i)|&=|\barz e^{i\theta}+ i e^{i\theta}|=|(\barz+i)e^{i\theta}|=|\barz+ i|=|\barz-\bari|=|z-i|

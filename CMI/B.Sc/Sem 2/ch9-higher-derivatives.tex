...
\begin{myproof}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw[fill=black] (0,0) node[yshift=-3mm]{$(a_1,a_2,a_3)$} circle (1pt);
			\draw[fill=black] (2,0) node[yshift=-3mm]{$(a_1,a_2,a_3)$} circle (1pt);
			\draw[fill=black] (3,0) node[yshift=-3mm]{$(a_1,a_2,a_3)$} circle (1pt);
			\draw[fill=black] (3.6,0.4) node[xshift=-3mm]{$(a_1,a_2,a_3)$} circle (1pt);
			\draw[fill=black] (4.5,1) node[xshift=-3mm]{$(a_1,a_2,a_3)$} circle (1pt);
			\draw[fill=black] (4.5,2.2) node[xshift=-3mm]{$(a_1,a_2,a_3)$} circle (1pt);
			\draw[fill=black] (4.5,3) node[xshift=-3mm]{$(a_1,a_2,a_3)$} circle (1pt);
		\end{tikzpicture}
	\end{center}

...
\begin{myproof}
	...
	\begin{center}
	 \begin{tikzcd}[every label/.append style={font=\normalsize}]
			...
			\end{tikzcd}
		\end{center}
	We get $\in(0,1)$ such that $\|g(1)-g(0)\|\leq \|g'(t)\|$ i.e $$\|f(b)-f(a)\|\leq \| \underbrace{f'(\gamma(t))\circ \gamma'(t)}_{\substack{ \downarrow \\ \text{Matrix Vector} \\ \text{Multiplication} }} \|\leq  M\|b-a\|$$
\end{myproof}
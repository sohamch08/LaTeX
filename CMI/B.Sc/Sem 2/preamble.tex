...
\newcommand{\exc}[2]{\begin{example}{#1}{}#2\end{example}}
\newcommand{\dfn}[2]{\begin{Definition}[colbacktitle=red!75!black]{#1}{}#2\end{Definition}}
\newcommand{\dfnc}[2]{\begin{definition}[colbacktitle=red!75!black]{#1}{}#2\end{definition}}
\newcommand{\opn}[2]{\begin{open}[colbacktitle=myp!75!black]{#1}{}#2\end{open}}
\newcommand{\opnc}[2]{\begin{Open}[colbacktitle=myp!75!black]{#1}{}#2\end{Open}}
